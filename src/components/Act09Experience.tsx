  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Headline */}
        <h2 className="text-headline lg:text-8xl">
          Tomorrow Begins <br />
          <span className="italic font-normal text-[#003B95]">Tonight.</span>
        </h2>

        <p className="text-slate-600 max-w-xl mx-auto leading-relaxed text-base md:text-lg lg:text-xl font-light">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-[var(--spacing-md)] pt-[var(--spacing-md)]">
          ...
          <button 
            ...
            aria-label="Experience SensAI: Open 100-night trial reservation"
          ...
          <a 
            ...
            aria-label="Locate a Store: Visit our flagship studio (opens in new tab)"
          ...
          >
            <MapPin className="w-4 h-4 text-[#003B95]" aria-hidden="true" />
